...
Java_com_east_ndklibjpeg_NativeImageUtils_compressBitmap(JNIEnv *env, jclass clazz, jobject bitmap,
                                                         jint q, jstring p_) {
    if (bitmap == NULL) {
        LOGE("bitmap is null");
        return;
...
Java_com_east_ndklibjpeg_NativeImageUtils_zoomCompress(JNIEnv *env, jclass clazz, jstring input_,
